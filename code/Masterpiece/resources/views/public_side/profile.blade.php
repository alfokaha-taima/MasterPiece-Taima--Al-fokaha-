   ...
   <div class="row">
      <div class="col-md-12">
         <div id="content" class="content content-full-width">
                    ...
                    <ul class="timeline">
                       <li>
                          ...
                          <div class="timeline-body">
                                ...
                                <span class="userimage"><img src="images/{{$product['image']}}" alt=""></span>
                                <span class="username"><a href="">{{$product['title']}}</a> <small></small></span>
                                <span class="pull-right text-muted">{{$product['price']}}JD</span>
            ...
            @else 
            <div>
                <h3 class="text-center" style="margin: 30px">No posts yet</h3>
            </div>
        @endif
